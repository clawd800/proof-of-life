...
export function useGameState() {
  const { data, isLoading, refetch } = useReadContracts({
    contracts: [
      ...
      { ...contract, functionName: "totalEverRegistered" },
  ...
  return {
    ...
    totalEverRegistered: get(2) as bigint | undefined,
    totalPool: get(3) as bigint | undefined,
    totalRewardsDistributed: get(4) as bigint | undefined,
    registryLength: get(5) as bigint | undefined,
    currentEpoch: get(6) as bigint | undefined,
    epochDuration: get(7) as bigint | undefined,
    costPerEpoch: get(8) as bigint | undefined,
    isLoading,
    refetch,
  };
}
